...
CONSTANTS[45] =  (1.00000/7.00000)*(Math.exp(CONSTANTS[10]/67.3000) - 1.00000);
...
{
ALGEBRAIC[12] = Math.pow(1.00000+STATES[12]/0.000350000, - 1.00000);
RATES[15] = (ALGEBRAIC[12] - STATES[15])/CONSTANTS[44];
ALGEBRAIC[10] = Math.pow(1.00000+Math.exp((STATES[0]+10.0000)/- 8.00000), - 1.00000);
ALGEBRAIC[27] = (Math.abs(STATES[0]+10.0000)<1.00000e-10 ? 4.57900/(1.00000+Math.exp((STATES[0]+10.0000)/- 6.24000)) : (1.00000 - Math.exp((STATES[0]+10.0000)/- 6.24000))/( 0.0350000*(STATES[0]+10.0000)*(1.00000+Math.exp((STATES[0]+10.0000)/- 6.24000))));
RATES[13] = (ALGEBRAIC[10] - STATES[13])/ALGEBRAIC[27];
ALGEBRAIC[11] = Math.exp(- (STATES[0]+28.0000)/6.90000)/(1.00000+Math.exp(- (STATES[0]+28.0000)/6.90000));
ALGEBRAIC[28] =  9.00000*Math.pow( 0.0197000*Math.exp( - Math.pow(0.0337000, 2.00000)*Math.pow(STATES[0]+10.0000, 2.00000))+0.0200000, - 1.00000);
RATES[14] = (ALGEBRAIC[11] - STATES[14])/ALGEBRAIC[28];
ALGEBRAIC[13] = (Math.abs(STATES[0] - 7.90000)<1.00000e-10 ? ( 6.00000*0.200000)/1.30000 : ( 6.00000*(1.00000 - Math.exp(- (STATES[0] - 7.90000)/5.00000)))/( (1.00000+ 0.300000*Math.exp(- (STATES[0] - 7.90000)/5.00000))*1.00000*(STATES[0] - 7.90000)));
ALGEBRAIC[29] = 1.00000 - Math.pow(1.00000+Math.exp(- (STATES[0] - 40.0000)/17.0000), - 1.00000);
RATES[19] = (ALGEBRAIC[29] - STATES[19])/ALGEBRAIC[13];
ALGEBRAIC[1] = (STATES[0]==- 47.1300 ? 3.20000 : ( 0.320000*(STATES[0]+47.1300))/(1.00000 - Math.exp( - 0.100000*(STATES[0]+47.1300))));
ALGEBRAIC[18] =  0.0800000*Math.exp(- STATES[0]/11.0000);
...
ALGEBRAIC[2] = (STATES[0]<- 40.0000 ?  0.135000*Math.exp((STATES[0]+80.0000)/- 6.80000) : 0.00000);
ALGEBRAIC[19] = (STATES[0]<- 40.0000 ?  3.56000*Math.exp( 0.0790000*STATES[0])+ 310000.*Math.exp( 0.350000*STATES[0]) : 1.00000/( 0.130000*(1.00000+Math.exp((STATES[0]+10.6600)/- 11.1000))));
...
ALGEBRAIC[3] = (STATES[0]<- 40.0000 ? ( ( - 127140.*Math.exp( 0.244400*STATES[0]) -  3.47400e-05*Math.exp( - 0.0439100*STATES[0]))*(STATES[0]+37.7800))/(1.00000+Math.exp( 0.311000*(STATES[0]+79.2300))) : 0.00000);
ALGEBRAIC[20] = (STATES[0]<- 40.0000 ? ( 0.121200*Math.exp( - 0.0105200*STATES[0]))/(1.00000+Math.exp( - 0.137800*(STATES[0]+40.1400))) : ( 0.300000*Math.exp( - 2.53500e-07*STATES[0]))/(1.00000+Math.exp( - 0.100000*(STATES[0]+32.0000))));
...
ALGEBRAIC[4] =  0.650000*Math.pow(Math.exp((STATES[0] - - 10.0000)/- 8.50000)+Math.exp(((STATES[0] - - 10.0000) - 40.0000)/- 59.0000), - 1.00000);
ALGEBRAIC[21] =  0.650000*Math.pow(2.50000+Math.exp(((STATES[0] - - 10.0000)+72.0000)/17.0000), - 1.00000);
ALGEBRAIC[34] = Math.pow(ALGEBRAIC[4]+ALGEBRAIC[21], - 1.00000)/CONSTANTS[13];
ALGEBRAIC[44] = Math.pow(1.00000+Math.exp(((STATES[0] - - 10.0000)+10.4700)/- 17.5400), - 1.00000);
RATES[6] = (ALGEBRAIC[44] - STATES[6])/ALGEBRAIC[34];
ALGEBRAIC[5] = Math.pow(18.5300+ 1.00000*Math.exp(((STATES[0] - - 10.0000)+103.700)/10.9500), - 1.00000);
ALGEBRAIC[22] = Math.pow(35.5600+ 1.00000*Math.exp(((STATES[0] - - 10.0000) - 8.74000)/- 7.44000), - 1.00000);
ALGEBRAIC[35] = Math.pow(ALGEBRAIC[5]+ALGEBRAIC[22], - 1.00000)/CONSTANTS[13];
ALGEBRAIC[45] = Math.pow(1.00000+Math.exp(((STATES[0] - - 10.0000)+33.1000)/5.30000), - 1.00000);
RATES[7] = (ALGEBRAIC[45] - STATES[7])/ALGEBRAIC[35];
ALGEBRAIC[6] =  0.650000*Math.pow(Math.exp((STATES[0] - - 10.0000)/- 8.50000)+Math.exp(((STATES[0] - - 10.0000) - 40.0000)/- 59.0000), - 1.00000);
ALGEBRAIC[23] =  0.650000*Math.pow(2.50000+Math.exp(((STATES[0] - - 10.0000)+72.0000)/17.0000), - 1.00000);
ALGEBRAIC[36] = Math.pow(ALGEBRAIC[6]+ALGEBRAIC[23], - 1.00000)/CONSTANTS[13];
ALGEBRAIC[46] = Math.pow(1.00000+Math.exp(((STATES[0] - - 10.0000)+20.3000)/- 9.60000), - 1.00000);
RATES[8] = (ALGEBRAIC[46] - STATES[8])/ALGEBRAIC[36];
ALGEBRAIC[7] = Math.pow(21.0000+ 1.00000*Math.exp(((STATES[0] - - 10.0000) - 195.000)/- 28.0000), - 1.00000);
ALGEBRAIC[24] = 1.00000/Math.exp(((STATES[0] - - 10.0000) - 168.000)/- 16.0000);
ALGEBRAIC[37] = Math.pow(ALGEBRAIC[7]+ALGEBRAIC[24], - 1.00000)/CONSTANTS[13];
ALGEBRAIC[47] = Math.pow(1.00000+Math.exp(((STATES[0] - - 10.0000) - 109.450)/27.4800), - 1.00000);
RATES[9] = (ALGEBRAIC[47] - STATES[9])/ALGEBRAIC[37];
ALGEBRAIC[8] = (Math.abs(STATES[0]+14.1000)<1.00000e-10 ? 0.00150000 : ( 0.000300000*(STATES[0]+14.1000))/(1.00000 - Math.exp((STATES[0]+14.1000)/- 5.00000)));
ALGEBRAIC[25] = (Math.abs(STATES[0] - 3.33280)<1.00000e-10 ? 0.000378361 : ( 7.38980e-05*(STATES[0] - 3.33280))/(Math.exp((STATES[0] - 3.33280)/5.12370) - 1.00000));
ALGEBRAIC[38] = Math.pow(ALGEBRAIC[8]+ALGEBRAIC[25], - 1.00000);
ALGEBRAIC[48] = Math.pow(1.00000+Math.exp((STATES[0]+14.1000)/- 6.50000), - 1.00000);
RATES[10] = (ALGEBRAIC[48] - STATES[10])/ALGEBRAIC[38];
ALGEBRAIC[9] = (Math.abs(STATES[0] - 19.9000)<1.00000e-10 ? 0.000680000 : ( 4.00000e-05*(STATES[0] - 19.9000))/(1.00000 - Math.exp((STATES[0] - 19.9000)/- 17.0000)));
ALGEBRAIC[26] = (Math.abs(STATES[0] - 19.9000)<1.00000e-10 ? 0.000315000 : ( 3.50000e-05*(STATES[0] - 19.9000))/(Math.exp((STATES[0] - 19.9000)/9.00000) - 1.00000));
ALGEBRAIC[39] =  0.500000*Math.pow(ALGEBRAIC[9]+ALGEBRAIC[26], - 1.00000);
ALGEBRAIC[49] = Math.pow(1.00000+Math.exp((STATES[0] - 19.9000)/- 12.7000), - 0.500000);
RATES[11] = (ALGEBRAIC[49] - STATES[11])/ALGEBRAIC[39];
ALGEBRAIC[40] =  (( CONSTANTS[0]*CONSTANTS[1])/CONSTANTS[2])*Math.log(CONSTANTS[12]/STATES[5]);
ALGEBRAIC[50] = ( CONSTANTS[3]*CONSTANTS[11]*(STATES[0] - ALGEBRAIC[40]))/(1.00000+Math.exp( 0.0700000*(STATES[0]+80.0000)));
ALGEBRAIC[51] =  CONSTANTS[3]*CONSTANTS[14]*Math.pow(STATES[6], 3.00000)*STATES[7]*(STATES[0] - ALGEBRAIC[40]);
ALGEBRAIC[52] = 0.00500000+0.0500000/(1.00000+Math.exp((STATES[0] - 15.0000)/- 13.0000));
ALGEBRAIC[53] =  CONSTANTS[3]*ALGEBRAIC[52]*Math.pow(STATES[8], 3.00000)*STATES[9]*(STATES[0] - ALGEBRAIC[40]);
ALGEBRAIC[54] = ( CONSTANTS[3]*CONSTANTS[15]*STATES[10]*(STATES[0] - ALGEBRAIC[40]))/(1.00000+Math.exp((STATES[0]+15.0000)/22.4000));
ALGEBRAIC[55] =  CONSTANTS[3]*CONSTANTS[16]*Math.pow(STATES[11], 2.00000)*(STATES[0] - ALGEBRAIC[40]);
ALGEBRAIC[57] = Math.pow(1.00000+ 0.124500*Math.exp(( - 0.100000*CONSTANTS[2]*STATES[0])/( CONSTANTS[0]*CONSTANTS[1]))+ 0.0365000*CONSTANTS[45]*Math.exp(( - CONSTANTS[2]*STATES[0])/( CONSTANTS[0]*CONSTANTS[1])), - 1.00000);
ALGEBRAIC[58] = ( (( CONSTANTS[3]*CONSTANTS[20]*ALGEBRAIC[57]*1.00000)/(1.00000+Math.pow(CONSTANTS[18]/STATES[1], 1.50000)))*CONSTANTS[12])/(CONSTANTS[12]+CONSTANTS[19]);
...
ALGEBRAIC[17] =  (( CONSTANTS[0]*CONSTANTS[1])/CONSTANTS[2])*Math.log(CONSTANTS[10]/STATES[1]);
ALGEBRAIC[30] =  CONSTANTS[3]*CONSTANTS[9]*Math.pow(STATES[2], 3.00000)*STATES[3]*STATES[4]*(STATES[0] - ALGEBRAIC[17]);
ALGEBRAIC[63] = ( CONSTANTS[3]*CONSTANTS[25]*( Math.exp(( CONSTANTS[29]*CONSTANTS[2]*STATES[0])/( CONSTANTS[0]*CONSTANTS[1]))*Math.pow(STATES[1], 3.00000)*CONSTANTS[24] -  Math.exp(( (CONSTANTS[29] - 1.00000)*CONSTANTS[2]*STATES[0])/( CONSTANTS[0]*CONSTANTS[1]))*Math.pow(CONSTANTS[10], 3.00000)*STATES[12]))/( (Math.pow(CONSTANTS[26], 3.00000)+Math.pow(CONSTANTS[10], 3.00000))*(CONSTANTS[27]+CONSTANTS[24])*(1.00000+ CONSTANTS[28]*Math.exp(( (CONSTANTS[29] - 1.00000)*STATES[0]*CONSTANTS[2])/( CONSTANTS[0]*CONSTANTS[1]))));
...
ALGEBRAIC[0] = (VOI>=CONSTANTS[4]&&VOI<=CONSTANTS[5]&&(VOI - CONSTANTS[4]) -  Math.floor((VOI - CONSTANTS[4])/CONSTANTS[6])*CONSTANTS[6]<=CONSTANTS[7] ? CONSTANTS[8] : 0.00000);
...
ALGEBRAIC[59] =  (( CONSTANTS[0]*CONSTANTS[1])/( 2.00000*CONSTANTS[2]))*Math.log(CONSTANTS[24]/STATES[12]);
...
ALGEBRAIC[65] =  CONSTANTS[31]*Math.pow(STATES[17], 2.00000)*STATES[18]*STATES[19]*(STATES[16] - STATES[12]);
ALGEBRAIC[67] = (STATES[20] - STATES[16])/CONSTANTS[32];
RATES[16] =  (ALGEBRAIC[67] - ALGEBRAIC[65])*Math.pow(1.00000+( CONSTANTS[38]*CONSTANTS[41])/Math.pow(STATES[16]+CONSTANTS[41], 2.00000), - 1.00000);
...
ALGEBRAIC[68] = Math.pow(1.00000+Math.exp(- (ALGEBRAIC[66] - 3.41750e-13)/1.36700e-15), - 1.00000);
RATES[17] = (ALGEBRAIC[68] - STATES[17])/CONSTANTS[46];
ALGEBRAIC[69] = 1.91000+ 2.09000*Math.pow(1.00000+Math.exp(- (ALGEBRAIC[66] - 3.41750e-13)/1.36700e-15), - 1.00000);
ALGEBRAIC[71] = 1.00000 - Math.pow(1.00000+Math.exp(- (ALGEBRAIC[66] - 6.83500e-14)/1.36700e-15), - 1.00000);
...
ALGEBRAIC[74] = 1.00000+( CONSTANTS[37]*CONSTANTS[40])/Math.pow(STATES[12]+CONSTANTS[40], 2.00000)+( CONSTANTS[36]*CONSTANTS[39])/Math.pow(STATES[12]+CONSTANTS[39], 2.00000);
